# -*- coding: utf-8 -*-
"""
Created on Fri Sep 13 17:57:03 2019
...
#(per instance), it is not the most efficient. There is a trickier but more efficient solution:
#you can reshape the RNN outputs from [batch_size, n_steps, n_neurons]
...
#Then we stack all the outputs using the reshape() operation, apply the fully connected
#linear layer (without using any activation function; this is just a projection), and
#finally unstack all the outputs, again using reshape():

## WITHOUT USING AN OUTPUT PROJECTION WRAPPER
